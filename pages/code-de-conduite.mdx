...
<LyonJSHead
  title="LyonJS | Code de conduite"
  description="Code de conduite et réglementation relative aux évènements de l'association LyonJS. Critères et application y sont détaillés"
/>
