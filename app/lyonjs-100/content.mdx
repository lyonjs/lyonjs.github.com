...
import { PhotoAlbum } from '../../modules/event/components/PhotoAlbum';
import { lyonjs100Photos } from '../../data/lyonjs100-photos';
...
Pour ce faire, nous avons privatisé une **salle de cinéma de l'UGC Part-Dieu pour l'occasion**, de quoi offrir un cadre agréable pour une journée rythmée par des talks de qualité.
...
<div className={styles.container}>
  <PhotoAlbum photoAlbum={lyonjs100Photos} />
</div>
